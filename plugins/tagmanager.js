var tagManager = function() {
	...
	function putTracks(holder, tracks, title) {
		var html = '<table align="center" style="border-collapse:collapse;width:96%"><tr class="tagh"><th colspan="2" align="center">'+title+'</th><th width="20px"><img class="clickicon infoclick plugclickable clickdeltag" src="newimages/edit-delete.png" height="16px" /></th></tr>';
		for (var i in tracks) {
			...
			html = html + '<td align="center" style="vertical-align:middle"><img class="clickicon infoclick plugclickable clickremtag" src="newimages/edit-delete.png" height="12px" /></td></tr>';
		}
		html = html + '</table>';
		holder.html(html);
	}
