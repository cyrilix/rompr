...
//
?>
    <div class="fullwidth" id="mopidysearcher">
        <div class="indent containerbox padright">
            <h3>Search For:</h3>
        </div>
        <div class="indent containerbox padright wibble">
...
?>
        <div class="indent containerbox padright">
            ...
            <button class="fixed" onclick="player.doMopidySearch('search')">Search</button>
