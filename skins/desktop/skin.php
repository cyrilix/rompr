        ...
        <div id="firefoxisshitwrapper" class="expand">
            ...
            <div id="amontobin" class="clearfix">
                ...
                <div id="lastfm" class="invisible topstats">
                    ...
                    print '<i title="'.get_int_text('button_ban').
                        '" class="icon-block npicon clickicon lettuce" id="ban"></i>';
                    ?>
                </div>
...
<?php
print '<i title="'.get_int_text('button_local_music').
    '" class="icon-music tooltip topimg choose_albumlist"></i>';
print '<i title="'.get_int_text('button_searchmusic').
    '" class="icon-search topimg tooltip choose_searcher"></i>';
print '<i title="'.get_int_text('button_file_browser').
...
<?php
print '<i id="sourcesresizer" class="icon-resize-horizontal topimg fixed topbox" '.
    'style="cursor:move"></i>';
?>
</div>
...
<?php
 print '<i title="'.get_int_text('button_togglesources').
    '" class="icon-angle-double-left tooltip topimg fixed topbox" id="expandleft"></i>';
 ?>

<div id="chooserbuttons" class="noborder expand center topbox containerbox">
<?php
print '<div class="topdrop fixed"><i class="icon-menu topimg tooltip" title="'.
    get_int_text('button_plugins').'"></i>';
?>
...
<?php
print '<div class="topdrop fixed"><i class="icon-versions topimg tooltip" title="'.
    get_int_text('button_history').'"></i>';
?>
...
<?php
print '<i title="'.get_int_text('button_back').
    '" id="backbutton" class="icon-left-circled topimg tooltip button-disabled fixed"></i>';
print '<i title="'.get_int_text('button_forward').
    '" id="forwardbutton" class="icon-right-circled tooltip topimg button-disabled fixed"></i>';
?>
</div>

<?php
print '<i class="icon-angle-double-right tooltip topimg fixed topbox" title="'.
    get_int_text('button_toggleplaylist').'" id="expandright"></i>';
?>
</div>

<div id="playlistcontrols" class="column noborder tleft containerbox headercontainer">
<?php
print '<div class="expand"><i id="playlistresizer" class="icon-resize-horizontal topimg topbox" '.
    'style="cursor:move"></i></div>';
?>
...
<?php
print '<div class="topdrop"><i class="icon-trash topimg tooltip" title="'.
    get_int_text('button_clearplaylist').'"></i>';
?>
...
<?php
print '<div class="topdrop"><i class="icon-floppy topimg tooltip" title="'.
    get_int_text('button_saveplaylist').'"></i>';
?>
