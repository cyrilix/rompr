...
foreach($x->stations->station as $i => $station) {
    ...
    print '<table><tr><td rowspan="2" style="width:24px">';
    ...
    foreach($station->link as $j => $link) {
        ...
        print '<tr><td width="20px"></td><td><b><a href="#" onclick="getInternetPlaylist(\''.$link->playlist.'\', \''.$station->image.'\', \''.$station->name.'\', \'Soma FM\')">'.$pl.'</a></b></td></tr>';
    }
    print '</table></div>';
