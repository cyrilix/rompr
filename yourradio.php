...
foreach($playlists as $i => $file) {
      ...
      foreach($x->trackList->track as $i => $track) {
      		print '<tr><td><img src="'.$track->image.'" height="20px"></td><td><a style="padding-left:0px" href="#" onclick="playUserStream(\''.htmlentities(rawurlencode($file)).'\');">'.$track->album.'</a></td>';
        	print '<td class="playlisticon" align="right"><a style="padding-left:0px" href="#" onclick="removeUserStream(\''.htmlentities(rawurlencode($file)).'\');">';
